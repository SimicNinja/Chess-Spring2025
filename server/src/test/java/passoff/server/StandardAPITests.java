...
public class StandardAPITests
{
    ...
    {
        TestUser[] incompleteLoginRequests = {new TestUser(null, existingUser.getPassword(), existingUser.getEmail()), new TestUser(existingUser.getUsername(), null, existingUser.getEmail()),};
